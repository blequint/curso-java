...
class PanelAccion extends JPanel{
	public PanelAccion(){
		URL rutaAmarillo=PanelAccion.class.getResource("bola_amarilla.png");
		URL rutaAzul=PanelAccion.class.getResource("bola_azul.gif");
		URL rutaRojo=PanelAccion.class.getResource("rojo.jpg");
